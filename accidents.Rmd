...
- Les heures et minutes des accidents sont concaténées dans une seule colonne, avec omission des `0` devant les heures de 00 à 09 et devant les minutes de 01 à 09. La documentation n’étant pas claire sur ce point, il faut donc à priori faire notre propre interprétation lorsque l’on est face à des valeurs du type ‘45’ : s’agit-il de 04:05 ou de 04:50 ? Ou encore la valeur ‘1’ correspond à 00:01 ou à 01:00 ?
...
Attention, cela ne veut pas dire que les usagers de la route sont plus prudents pendant les vacances. Cela peut s'expliquer probablement et au moins en partie par le fait qu'il y a globalement moins de circulation durant les périodes de vacances, et donc moins d'accidents.
